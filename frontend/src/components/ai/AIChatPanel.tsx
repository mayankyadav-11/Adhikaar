  ...
  const [messages, setMessages] = useState([
    {
      id: "1",
      sender: "user",
      text: activeQuery || "I have been working as a technician in an automotive workshop in Gurugram for 8 months. The employer hasn't paid salary for October and November (₹38,000 total). When I ask, they threaten to terminate me.",
      time: "11:42 AM",
    },
  ]);
          ...
          <div className="flex flex-col gap-3 w-full">
            <div className="bg-surface-container-lowest p-4 rounded-xl rounded-tl-none shadow-sm flex flex-col gap-3">
              ...
              <p className="font-body-sm text-body-sm text-on-surface leading-relaxed">
                Under the <strong>Payment of Wages Act, 1936</strong> and the Industrial Disputes framework, you are legally entitled to your wages within <strong>7–10 days</strong> of wage period expiry. Retaliatory termination without due procedure or mandatory notice pay is unlawful.
              </p>
