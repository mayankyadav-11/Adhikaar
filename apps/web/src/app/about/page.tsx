      ...
      <div className="page-container-narrow">
        <header className="mb-10 sm:mb-12">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant mt-3 leading-relaxed">
            Adhikaar is built on the belief that knowing your rights and accessing government
            welfare should not require legal intermediaries, bribes, or bureaucratic fear.
          </p>
        </header>
        ...
        <div className="flex flex-col gap-8 sm:gap-10 text-on-surface">
          <section className="p-6 sm:p-8 lg:p-10 bg-surface-container-lowest rounded-3xl shadow-sm border border-outline-variant/20">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
              The Constitution of India directs the State to secure that the operation of the legal
              system promotes justice on a basis of equal opportunity, and shall, in particular,
              provide free legal aid by suitable legislation or schemes. Adhikaar acts as the
              digital infrastructure that puts these protections directly into the hands of
              citizens.
            </p>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 mt-6">
              <div className="p-5 sm:p-6 rounded-2xl bg-surface-container-low border border-outline-variant/15">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant mt-1.5 leading-relaxed">
                  We charge zero fees to citizens. No sponsored schemes or commercial
                  prioritization.
                </p>
              </div>
              <div className="p-5 sm:p-6 rounded-2xl bg-surface-container-low border border-outline-variant/15">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant mt-1.5 leading-relaxed">
                  We never store Aadhaar numbers, PAN numbers, or biometrics. All eligibility
                  calculations happen with minimal anonymized descriptors.
                </p>
              </div>
              <div className="p-5 sm:p-6 rounded-2xl bg-surface-container-low border border-outline-variant/15">
                <span className="font-title-md text-title-md text-primary font-bold block">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant mt-1.5 leading-relaxed">
                  Designed for Bharat. Voice and text support in Hindi, Punjabi, Bengali, Tamil,
                  Telugu, and more.
                </p>
              </div>
              <div className="p-5 sm:p-6 rounded-2xl bg-surface-container-low border border-outline-variant/15">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant mt-1.5 leading-relaxed">
                  Every guidance card references specific acts, official gazette notifications, and
