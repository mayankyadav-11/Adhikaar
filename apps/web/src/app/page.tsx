      ...
      <div className="relative w-full overflow-hidden">
        ...
        <section className="page-container pt-12 sm:pt-16 lg:pt-20 pb-16 sm:pb-20 lg:pb-24 flex flex-col items-center text-center">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mt-5 sm:mt-6 leading-relaxed">
            Tell Adhikaar what you&apos;re dealing with. We&apos;ll help you understand what
            statutory support may be available, required documents, and what verified action you can
            take next.
          </p>

          {/* Live System Connectivity Indicator */}
          <div className="mt-5 flex items-center justify-center gap-2">
            <span className="font-label-sm text-label-sm text-on-surface-variant/80">
              Frontend Status:
            </span>
            <ApiStatusIndicator variant="pill" />
          </div>
          ...
          <div className="w-full max-w-3xl mt-10 sm:mt-12 text-left bg-surface-container-lowest rounded-2xl shadow-xl p-6 sm:p-8 relative transition-all duration-300 hover:shadow-2xl border border-outline-variant/30">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-5 mt-4 bg-surface-container-low/50 -mx-6 sm:-mx-8 -mb-6 sm:-mb-8 px-6 sm:px-8 py-4 sm:py-5 rounded-b-2xl border-t border-outline-variant/20">
              ...
              >
                <span
                  className={`material-symbols-outlined text-[18px] text-error ${isListening ? "animate-pulse" : ""}`}
                >
                  mic
                </span>
          ...
          <div className="w-full max-w-3xl mt-6 sm:mt-8 flex flex-wrap items-center justify-center gap-2 sm:gap-2.5">
            ...
            <button
              ...
              className="font-label-sm text-label-sm text-on-surface-variant bg-surface-container-low hover:bg-surface-container px-3.5 py-1.5 rounded-full transition-colors active:scale-95 cursor-pointer"
              onClick={() =>
                fillQuery("How to apply for priority ration card (NFSA) online in Haryana?")
              }
            >
            ...
            <button
              ...
              className="font-label-sm text-label-sm text-on-surface-variant bg-surface-container-low hover:bg-surface-container px-3.5 py-1.5 rounded-full transition-colors active:scale-95 cursor-pointer"
              onClick={() =>
                fillQuery("Landlord refuses to refund ₹45,000 security deposit without damages")
              }
            >
              Tenant dispute
            </button>
            <button
              ...
              className="font-label-sm text-label-sm text-on-surface-variant bg-surface-container-low hover:bg-surface-container px-3.5 py-1.5 rounded-full transition-colors active:scale-95 cursor-pointer"
              onClick={() =>
                fillQuery("Old age pension eligibility criteria for BPL widow aged 63 years")
              }
            >
              Elderly pension
            </button>
            <button
              ...
              onClick={() =>
                fillQuery(
                  "Received SMS saying electricity will be cut tonight unless I click this link"
                )
              }
            >
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 sm:mb-12 gap-3">
          <div className="flex flex-col max-w-xl">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant mt-2 leading-relaxed">
              Direct conduits to institutional remedies, statutory entitlements, and official
              dispute filings.
            </p>
          </div>
          <span className="font-label-sm text-label-sm text-on-surface-variant">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-7 lg:gap-8">
          ...
          >
            <div className="flex flex-col">
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant mt-2.5 leading-relaxed">
                Check direct eligibility, subsidy brackets, and documentation across 450+ central
                and state programs.
              </p>
            </div>
          ...
          >
            <div className="flex flex-col">
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant mt-2.5 leading-relaxed">
                Plain-spoken breakdowns of statutory acts: labour wages, consumer grievances,
                tenancy, and civil entitlements.
              </p>
            </div>
            <div className="flex items-center gap-2 mt-6 pt-3.5 bg-surface-container-low/60 -mx-6 sm:-mx-7 -mb-6 sm:-mb-7 px-6 sm:px-7 py-3 rounded-b-2xl border-t border-outline-variant/15">
          ...
          <div
            onClick={() =>
              fillQuery(
                "Check if this message is authentic: Congratulations you won ₹50000 lottery click here"
              )
            }
          ...
          >
            <div className="flex flex-col">
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant mt-2.5 leading-relaxed">
                Paste suspicious WhatsApp forwards, lottery SMS, or fake recruitment letters to
                evaluate authenticity against official cyber bulletins.
              </p>
            </div>
            <div className="flex items-center gap-2 mt-6 pt-3.5 bg-surface-container-low/60 -mx-6 sm:-mx-7 -mb-6 sm:-mb-7 px-6 sm:px-7 py-3 rounded-b-2xl border-t border-outline-variant/15">
          ...
          >
            <div className="flex flex-col">
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant mt-2.5 leading-relaxed">
                Locate your District Legal Services Authority (DLSA), Taluk committee, and pro-bono
                empanelled advocates under NALSA.
              </p>
            </div>
            <div className="flex items-center gap-2 mt-6 pt-3.5 bg-surface-container-low/60 -mx-6 sm:-mx-7 -mb-6 sm:-mb-7 px-6 sm:px-7 py-3 rounded-b-2xl border-t border-outline-variant/15">
              <span className="font-label-sm text-label-sm text-secondary font-semibold">
          ...
          >
            <div className="flex flex-col">
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant mt-2.5 leading-relaxed">
                Generate standardized RTI applications, formal dispute notices, demand letters, and
                consumer forum drafts in seconds.
              </p>
            </div>
            <div className="flex items-center gap-2 mt-6 pt-3.5 bg-surface-container-low/60 -mx-6 sm:-mx-7 -mb-6 sm:-mb-7 px-6 sm:px-7 py-3 rounded-b-2xl border-t border-outline-variant/15">
          ...
          >
            <div className="flex flex-col">
              ...
              <p className="font-body-sm text-body-sm text-on-surface-variant mt-2.5 leading-relaxed">
                Statutory limitation periods for complaints, ITR deadlines, scholarship submission
                windows, and civil appeal cutoffs.
              </p>
            </div>
            <div className="flex items-center gap-2 mt-6 pt-3.5 bg-surface-container-low/60 -mx-6 sm:-mx-7 -mb-6 sm:-mb-7 px-6 sm:px-7 py-3 rounded-b-2xl border-t border-outline-variant/15">
              <span className="font-label-sm text-label-sm text-primary font-semibold">
      ...
      <section className="w-full bg-surface-container-low py-16 sm:py-20 lg:py-24 border-y border-outline-variant/20">
        <div className="page-container">
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant mt-2 leading-relaxed">
              Engineered to convert bureaucratic complexity into sequential, empowering citizen
              action.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-7 lg:gap-8 relative">
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col justify-between relative overflow-hidden border border-outline-variant/20 min-h-[240px]">
              ...
              <div className="flex flex-col z-10">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant mt-3 leading-relaxed">
                  Express your situation in simple everyday speech or text. You don&apos;t need
                  legal jargon or formal English — we understand colloquial Hindi, regional idioms,
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col justify-between relative overflow-hidden border border-outline-variant/20 min-h-[240px]">
              ...
              <div className="flex flex-col z-10">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant mt-3 leading-relaxed">
                  Our system evaluates your query against India Code, Central Gazettes, and Welfare
                  Directories to instantly isolate applicable acts, exemptions, and entitlement
                  clauses.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col justify-between relative overflow-hidden border border-outline-variant/20 min-h-[240px]">
              ...
              <div className="flex flex-col z-10">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant mt-3 leading-relaxed">
                  Receive pre-drafted legal notices, official grievance portal links, direct DLSA
                  legal aid contact coordinates, and sequential checklists to resolve your matter
                  with dignity.
                </p>
              </div>
            </div>
        ...
        <div className="bg-primary text-on-primary rounded-3xl p-8 sm:p-12 lg:p-14 flex flex-col md:flex-row items-center justify-between gap-8 lg:gap-12 relative overflow-hidden shadow-xl">
          ...
          <div className="flex flex-col max-w-xl z-10 text-center md:text-left">
            ...
            <p className="font-body-md text-body-md text-primary-fixed mt-3 leading-relaxed">
              No waiting lines, no middlemen fees, and no legal intimidation. Discover what the
              Constitution of India and national welfare laws entitle you to today.
            </p>
          </div>
